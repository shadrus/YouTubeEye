...
class ApiReq():
    ...
    def set_search_uri(self, channel_id):
        self.search_uri = 'https://www.googleapis.com/youtube/v3/search?part=id&channelId=%s&maxResults=50&fields=items/id,nextPageToken&key=%s' % (channel_id['id'], self.conf.APP_KEY)
